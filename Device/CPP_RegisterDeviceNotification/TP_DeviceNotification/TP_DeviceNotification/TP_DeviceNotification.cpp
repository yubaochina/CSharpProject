// TP_DeviceNotification.cpp : Defines the entry point for the console application.
//
#include <windows.h>
#include <stdio.h>
#include <tchar.h>
...
//     see the documentation for WNDCLASSEX and CreateWindowEx.
{
	...
	case WM_DEVICECHANGE:
	{
		...
		case DBT_DEVICEARRIVAL:
			...
			MessageBox(NULL, L"New Device Arrived", L"Device Nodtification", MB_OK);
			break;
		...
		case DBT_DEVNODES_CHANGED:
			msgCount++;
			MessageBox(NULL, L"DBT_DEVNODES_CHANGED", L"Device Nodtification", MB_OK);
		/*	StringCchPrintf(
				strBuff, 256,
